        ...
        <div class="row justify-content-center">
            <div class="col-md-8 rounded" style="background-color: #D2DAFF">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Type anything for your Title.."'); ?>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <label for="">Thumbnail</label>
                        <?php echo form_upload('thumbnail', set_value('thumbnail'), 'class="form-control"'); ?>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="">Url</label>
                    <?php echo form_input('url', set_value('url'), 'class="form-control" placeholder="Your Url"'); ?>
                </div>
                <div class="form-group">
                    <label for="">Konten</label>
                    <?php echo form_textarea('content', set_value('conten'), 'class="form-control" id="summernote" cols="30" rows="10"'); ?>
                </div>
